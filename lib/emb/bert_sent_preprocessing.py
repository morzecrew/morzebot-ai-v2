...
# print(Evaluation().cos_dist(next(iter(BERTSentEmb().preprocessing("привет мир")["user_sent_and_emb"].values())),next(iter(BERTSentEmb().preprocessing("привет")["user_sent_and_emb"].values()))))